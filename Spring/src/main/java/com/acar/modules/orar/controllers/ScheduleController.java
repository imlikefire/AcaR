...
public class ScheduleController {
    ...
    @RequestMapping(value="/recommendByNota/{disciplina}",method = RequestMethod.GET)
    public ResponseEntity<List<Schedule>> recommendByNota (@PathVariable("disciplina") String disciplina){
        List<Orar> orar=this.service.getAll();
        List<Schedule> schedule=new ArrayList<>();
        long idDisciplina=this.disciplineService.getIdByName(disciplina);
    ...
    @RequestMapping(value="/recommendByProcentaj/{disciplina}",method = RequestMethod.GET)
    public ResponseEntity<List<Schedule>> recommendByProcentaj (@PathVariable("disciplina") String disciplina){
        List<Orar> orar=this.service.getAll();
        List<Schedule> schedule=new ArrayList<>();
        long idDisciplina=this.disciplineService.getIdByName(disciplina);
        List<Profesori> profs=new ArrayList<>();
